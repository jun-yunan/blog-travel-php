<div class="w-full h-full flex">
    <?php include "src/blog/view/components/side-bar.php"; ?>
    <main class="flex-1 flex flex-col items-center">
        <div class="flex items-center w-[70%] justify-center gap-x-6">
            <div class="flex items-center w-full border-2 border-gray-200 px-3 rounded-md overflow-hidden shadow-sm">
                <ion-icon name="search-outline"></ion-icon>
                <input type="text" placeholder="Search blog..." class="border-none focus:ring-0 w-full">
            </div>
            <button class="px-3 py-1 flex items-center justify-center gap-x-2 rounded-md border-2 border-gray-300">
                <ion-icon name="filter-outline"></ion-icon>
                <p>Filter</p>
            </button>
        </div>
        <div class="mt-6 w-[70%] flex items-center justify-center cursor-pointer">
    ...
    <?php include "src/blog/view/components/friends.php"; ?>
</div>