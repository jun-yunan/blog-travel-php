...
<!-- <h2><?php echo $_GET['id'] ? 'Cập nhật thông tin blog' : 'Thêm blog' ?></h2> -->
<a href="/blog">Back Blog Page</a>

<div class="py-16 flex items-center justify-center">
    <form method="POST" action="" class="w-[450px] flex flex-col border-2 border-gray-300 p-4 rounded-md space-y-8">
        <div class="flex flex-col self-start">
            <h1 class="text-xl font-semibold"><?php echo $_GET['id'] ? "Update Blog" : "Create Blog" ?></h1>
        ...
        <button type="submit" class="btn btn-primary w-[50%] self-end"><?php echo $_GET['id'] ? "Update Blog" : "Create Blog" ?></button>
    </form>
</div>
